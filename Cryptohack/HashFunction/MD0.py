...
# padding data, chia data thành các block, liên tục mã hóa AES mode ECB out với key là data và xor với chính nó
# return: out sau khi encrypt
def hash(data):
    data = pad(data, 16)
    out = b"\x00" * 16
...
class Challenge():
    ...
    def challenge(self, msg):
        ...
        #option sign, hash(key + message) => p0 = key
